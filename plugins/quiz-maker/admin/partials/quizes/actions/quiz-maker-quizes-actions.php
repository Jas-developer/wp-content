                                    ...
                                    <div class="col-sm-7 ays_divider_left">
                                        <div class="row">
                                            <div class="col-sm-5">
                                                <label for='ays_quiz_admin_note_text_transform'>
                                                    <?php echo esc_html__('On desktop', 'quiz-maker'); ?>
                                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr( __('Choose the line position for the Note Text on the front end for descktop devices. Note: It is set as None by default.','quiz-maker') ); ?>">
                                                        <i class="ays_fa ays_fa_info_circle"></i>
                                                    </a>
                                                </label>
                                            </div>
                                    ...
                                    <div class="col-sm-7 ays_divider_left">
                                        <div class="row">
                                            <div class="col-sm-5">
                                                <label for='ays_quiz_right_answers_text_decoration'>
                                                    <?php echo esc_html__('On desktop', 'quiz-maker'); ?>
                                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr( __('Choose the line position for the Right answer Text on the front end for descktop devices. Note: It is set as None by default.','quiz-maker') ); ?>">
                                                        <i class="ays_fa ays_fa_info_circle"></i>
                                                    </a>
                                                </label>
                                            </div>
