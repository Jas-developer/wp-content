   ...
   <div id="nav-items" class="nav-hidden pe-lg-5 col-lg-8 z-2">
      <ul class="list-unstyled  gap-lg-4 fw-semibold gap-3 nav flex-lg-row flex-column align-items-center">
        ...
        <li><a href="<?php echo esc_url(get_permalink(37));?>" 
         ...
         <li><a href="<?php echo esc_url(get_permalink(157)); ?>" class="<?php  if(is_page(157)): echo 'custom-underline'; else: echo 'text-decoration-none'; endif; ?> text-light">JOIN US</a></li>
