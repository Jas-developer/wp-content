...
<main class="front-page-wrapper">
  ...
  <div class="container-lg  container-fluid w-100 h-75 d-flex flex-row ps-lg-5 justify-content-lg-center align-items-center align-items-lg-start">
  <div class="w-100 d-flex flex-column justify-content-center align-items-center align-items-lg-start">
    <div class="position-relative mt-5">
      <h2 id="hero-section-heading" class="position-relative z-2">TESt TRAINING</h2>
  ...
  <div class="floating-info-container  position-relative">
    ...
    <!-- Small screen -->
    <div class=" bg-white position-relative d-block d-md-none justify-content-center align-items-center px-3 py-3 py-lg-5 shadow-lg w-100 container">
  ...
  <!-- ==========================
       ABOUT US SECTION ||
  =========================== -->
  <div class="about-us-container py-5 mt-n1 pt-md-3 pt-0 pt-lg-0 w-100 position-relative">
