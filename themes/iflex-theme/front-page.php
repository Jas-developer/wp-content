  ...
  <div class="w-100 d-flex mt-4 flex-column justify-content-center align-items-start">
    <div class="position-relative mt-5 px-3 px-md-0">
      ...
      <div class="w-100 d-flex gap-2 flex-column">
         <h3 class="fw-semibold text-white z-2">Training Ground for Greatness!Test</h3>
        <a class="btn btn-danger z-2 px-5 border border-0 text-light fw-bold  w-auto align-self-start">
         <span>JOIN NOW</span> <span class="dashicons dashicons-arrow-right-alt2"></span>
        </a>
      </div>
    </div>
  </div>
